              ...
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  ...
                  <p className="mt-2 text-sm leading-normal text-justify">
                    IQVIA is a world leader in using data, technology, and advanced analytics to help customers drive healthcare forward. In Australia and New Zealand our expertise helps companies across the region create a more modern, more effective and more efficient healthcare system, leading to breakthrough solutions that transform business and patient outcomes. 
                  </p>
                </div>
                <img
                  alt=""
                  ...
                  src={"/images/projects/iqvia.jpeg"}
                />
              </div>
            </li>
          ...
          <li className="mb-12">
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  ...
                  <p className="mt-2 text-sm leading-normal text-justify">
                  Budget & Cost prediction tool. SpendPlan empower finance and project delivery teams — designed to
                  help you identify, unlock, and capitalize on profit levers on all of your projects.
                  </p>
                </div>
                <img
                  alt=""
                  ...
                  className="rounded transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                  style={{ color: "transparent" }}
                  src={"/images/projects/spendplan.png"}
                />
              </div>
            </li>
              ...
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  <h3>
                    <a
                      className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base"
                      href="https://play.google.com/store/apps/details?id=tel.transcomdigital&hl=en_AU"
                      target="_blank"
                      rel="noreferrer"
