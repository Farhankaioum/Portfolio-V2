              ...
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:col-span-6">
                  <h3 className="font-medium leading-snug text-slate-200">
                    <div>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        aria-label="Full Stack Software Engineer at Ausis Accomodation Services"
                      >
                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                        <span>
                          Full Stack Software Engineer (Contractual){" - "}
                  ...
                  <div className="mt-2 text-sm leading-normal text-justify">
                    In my role as a Full Stack Software Engineer (Contructual) at Ausis Accomodation Center, I am responsible for understanding business requirements,
                    estimating tasks, and implementing features for their new website
                    and automating manual task.
                    I also deal with their existing products to support clients.
                  </div>
                  <ul
            ...
            <li className="mb-12">
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:col-span-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span>
                          Software Engineer {" - "}
                          <span className="inline-block">
                            Wunderman Thompson Studio Dhaka (Now - Hogarth Dhaka){" "}
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 20 20"
                              fill="currentColor"
                  ...
                  <div className="mt-2 text-sm leading-normal text-justify">
                    In my role as a Software Engineer at Wunderman Thompson Studio Dhaka (now Hogarth Dhaka), I was responsible for understanding requirements,
            ...
            <li className="mb-12">
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:col-span-6">
                  ...
                  <div className="mt-2 text-sm leading-normal text-justify">
                    I started my career as a Software Engineer (Intern) then got promoted to Junior Software Engineer.
